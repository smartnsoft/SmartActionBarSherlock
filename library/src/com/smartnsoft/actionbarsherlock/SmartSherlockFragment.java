 ...
 * @since 2013.02.04
 */
public abstract class SmartSherlockFragment<AggregrateClass>
    extends SherlockFragment
    implements Smartable<AggregrateClass>
{

  private Droid4mizer<AggregrateClass, SmartSherlockFragment<AggregrateClass>> droid4mizer;
  ...
  public void onAttach(Activity activity)
  {
    ...
    droid4mizer = new Droid4mizer<AggregrateClass, SmartSherlockFragment<AggregrateClass>>(activity, this, this, this);
  }
  ...
  public void onCreate(final Bundle savedInstanceState)
  {
    droid4mizer.onCreate(new Runnable()
    {
      public void run()
      {
        SmartSherlockFragment.super.onCreate(savedInstanceState);
      }
    }, savedInstanceState);
  }
