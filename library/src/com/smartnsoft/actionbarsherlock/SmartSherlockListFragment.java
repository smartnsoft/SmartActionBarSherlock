 ...
 * @since 2013.02.04
 */
public abstract class SmartSherlockListFragment<AggregateClass>
    extends SherlockListActivity
    implements SmartableActivity<AggregateClass>
{

  private final Droid4mizer<AggregateClass, SmartSherlockListFragment<AggregateClass>> droid4mizer = new Droid4mizer<AggregateClass, SmartSherlockListFragment<AggregateClass>>(this, this, this, null);
  ...
  protected void onCreate(final Bundle savedInstanceState)
  {
    droid4mizer.onCreate(new Runnable()
    {
      public void run()
      {
        SmartSherlockListFragment.super.onCreate(savedInstanceState);
      }
    }, savedInstanceState);
  }
